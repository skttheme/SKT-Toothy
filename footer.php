    	...
    	<div class="container footer">
              ...
              <?php $args = array( 'posts_per_page' => 3, 'post__not_in' => get_option('sticky_posts'), 'orderby' => 'date', 'order' => 'desc' );
                    ...
                    <?php while( $postquery->have_posts() ) : $postquery->the_post(); ?>
                        <div class="recent-post">
                            ...
                            <p><?php the_excerpt(); ?></p> 
                            <a class="morebtn" href="<?php echo esc_url( get_permalink() ); ?>"><?php esc_html_e('Read More','skt-toothy'); ?></a>                                              
                        </div>
                    <?php endwhile; ?>
         ...
         <div class="copyright-wrapper">
        	<div class="container">
            	 ...
            	 <div class="design-by"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-toothy');?><a href="<?php echo esc_url('https://www.sktthemes.org/product-category/responsive-dentist-wordpress-themes/');?>" target="_blank">
        <?php esc_html_e('SKT Dentist Themes','skt-toothy'); ?>
        </a>
</div>
                 <div class="clear"></div>
            </div>           
